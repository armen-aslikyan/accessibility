    ...
    <div className="space-y-6">
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-6xl font-black text-red-600 tracking-tighter">
              &euro;{summary.legalRisk?.total?.toLocaleString() || 0}
            </p>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-slate-600">{t('dashboard.technicalFine')}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="mt-1 w-2 h-2 rounded-full bg-red-500"></div>
              <p className="text-sm text-slate-600">{t('dashboard.declarationFine')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
          ...
          <p className="text-xs text-slate-500 mt-2">{t('dashboard.excludingNA')}</p>
        </div>
